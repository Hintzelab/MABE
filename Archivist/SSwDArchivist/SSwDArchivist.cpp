...
SSwDArchivist::SSwDArchivist(vector<string> aveFileColumns, string maxValueName, shared_ptr<ParametersTable> _PT) :
		DefaultArchivist(aveFileColumns, maxValueName, _PT) {
