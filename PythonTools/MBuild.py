...
outFile.write('\n\n//create an archivist\n')
outFile.write('shared_ptr<DefaultArchivist> makeArchivist(vector<string> aveFileColumns, shared_ptr<Abstract_MTree> _maxFormula, shared_ptr<ParametersTable> PT = Parameters::root, string groupPrefix = ""){\n')
...
for option in options["Archivist"]:
	...
	outFile.write('    newArchivist = make_shared<'+option+'Archivist>(aveFileColumns, _maxFormula, PT, groupPrefix);\n')
	outFile.write('    found = true;\n')	
	outFile.write('    }\n')
outFile.write('  if (!found){\n')
