...
shared_ptr<ParameterLink<string>> Global::initPopPL = Parameters::register_parameter("GLOBAL-initPop",(string) "population_loader.cfg"  , "initial population to start MABE");
