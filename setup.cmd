...
:;   echo "darwin"
:;   # OSX
:;   cp ${SCRIPT_DIR}/src/Utilities/osx_build ${SCRIPT_DIR}/mbuild
:; elif [ "$(expr substr $(uname -s) 1 5)" = 'Linux' ]; then
:;   # linux
:;   cp ${SCRIPT_DIR}/src/Utilities/lin_build ${SCRIPT_DIR}/mbuild
:; elif [ "$(expr substr $(uname -s) 1 10)" = 'MINGW32_NT' ]; then
:;   # windows (MSYS/MinGW)
:;   cp ${SCRIPT_DIR}/src/Utilities/win_build.exe ${SCRIPT_DIR}/mbuild.exe
