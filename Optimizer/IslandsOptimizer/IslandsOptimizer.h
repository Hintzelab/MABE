...
public:
  ...
  public:
    ...
    AbstractSelector(IslandsOptimizer *SO_) : SO(SO_){};
  ...
  public:
    RouletteSelector(std::string &argumentsString, IslandsOptimizer *SO_)
  ...
  public:
    int tournamentSize;
    TournamentSelector(std::string &argumentsString, IslandsOptimizer *SO_)
        : AbstractSelector(SO_) {
      // now decode arguments
      std::vector<std::string> arguments;
      std::stringstream ss(argumentsString); // Turn the string into a stream.
